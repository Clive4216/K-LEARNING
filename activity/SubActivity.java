...
import com.kidslearning.kidsplay.kidsgames.kidseducation.K_LEARNING.adapter.SubHomeAdapter;
...
public class SubActivity extends AppCompatActivity {
    ...
    public void prepareDataForLearning(int i2) {
        if (i2 == 0) {
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.orange1, "Orange", "Orange"));
