...
import com.kidslearning.kidsplay.kidsgames.kidseducation.K_LEARNING.customclasses.NonSwipeAbleViewPager;
...
//            imageView.startAnimation(AnimationUtils.loadAnimation(context, R.anim.bubble_anim));
    ...
    public void prepareDataForLearning(int i2) {
        if (i2 == 0) {
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.aa1, "A for Apple", "Apple"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.bb1, "B for Ball", "Ball"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.cc1, "C for Cat", "Cat"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.dd1, "D for Dog", "Dog"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.ee1, "E for Elephant", "Elephant"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.ff1, "F for Fish", "Fish"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.gg1, "G for Goat", "Goat"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.hh1, "H for Horse", "Horse"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.ii1, "I for Ice cream", "Ice cream"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.jj1, "J for Joker", "Joker"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.kk1, "K for Kite", "Kite"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.ll1, "L for Lion", "Lion"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.mm1, "M for Monkey", "Monkey"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.nn1, "N for Nest", "Nest"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.oo1, "O for Orange", "Orange"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.pp1, "P for Parrot", "Parrot"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.qq1, "Q for Queen", "Queen"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.rr1, "R for Rabbit", "Rabbit"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.ss1, "S for Sun", "Sun"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.tt1, "T for Train", "Train"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.uu1, "U for Umbrella", "Umbrella"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.vv1, "V for Violin", "Violin"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.ww1, "W for Watch", "Watch"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.xx1, "X for Xylophone", "Xylophone"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.yy1, "Y for Yak", "Yak"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.zz1, "Z for Zebra", "Zebra"));
        } else if (i2 == 1) {
            learningDataModelArrayList = new ArrayList();
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.zero_0_, "Zero", "Zero"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.one1_, "One", "One"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.two2_, "Two", "Two"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.three3_, "Three", "Three"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.four4_, "Four", "Four"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.five5_, "Five", "Five"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.six6_, "Six", "Six"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.seven7_, "Seven", "Seven"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.eight8_, "Eight", "Eight"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.nine9_, "Nine", "Nine"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.ten10_, "Ten", "Ten"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.twenty_2, "Twenty", "Twenty"));
        } else if (i2 == 2) {
            learningDataModelArrayList = new ArrayList();
          ...
          //  learningDataModelArrayList.add(new LearningDataModel(R.drawable.kha, "टण..\nटण..\nटण..\n" + "घण..\nघण..\nघण..\n" + "चल..\nचल..\n" + "टण..\nघण..\nचल", "तन तन …\n"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.na, " न", "ण"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.ssa, "श", "श"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.sa, "ष", "ष"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.jna, " ज्ञ", " ज्ञ"));
        } else if (i2 == 11) {
            learningDataModelArrayList = new ArrayList();
